...
public class MemClient {  
    ...
    public void setServers(List<SpyMemcachedServer> servers) {  
        this.servers = servers;  
    }
    public void setServer(SpyMemcachedServer server){
    	List<SpyMemcachedServer> list = new ArrayList<SpyMemcachedServer>();
    	list.add(server);
    	this.servers = list;
    }
    private MemClient(){
    ...
    public static MemClient getInstance(){
    	if(instance ==null){
